...
<aside class="right-side">
  <h6 align="right"><a href="https://staff.icstravelgroup.com/php-bin_v2/restaurant/restchk.php?ssid=<?=$ssid?>&isid=<?=$isid?>" target='_blank'>Old Version</a></h6>

      <h4 style="text-align:center;"><b>Current Restaurant Booking Report</b></h4><br>
            ...
            <div class="row">
              ...
              <div class="col-md-2">
                <div class="form-group">
                  <select class="form-control selectTo" name="" id="Country" OnChange="javascript:ChkCity(this.value);">
                    <option value=""></option>
                    @foreach($ContryArray as $ContryArrayData)
                      <option value="{{$ContryArrayData->Country}}"> {{$ContryArrayData->Country}} </option>
                    @endforeach
                  </select>
                </div>
              </div>
              ...
              <div class="col-md-2">
                <div class="form-group">
                  <select class="form-control selectTo" name="" id="City" OnChange="javascript:ChkRestaurant(this.value);">
                    <option value=""></option>
                    @foreach($CityArray as $CityArrayData)
                      <option value="{{$CityArrayData->City}}"> {{$CityArrayData->City}} </option>
                    @endforeach
                  </select>
                </div>
              </div>

              <div class="col-md-1" style="text-align:right;"><label style="font-size:12px"> Type off restaurant</label></div>
              <div class="col-md-2">
                <div class="form-group">
                  <select class="form-control" name="" id="TORestaurant">
                      <option value=""> All </option>
                      <option value="LR"> Local Restaurant </option>
                      <option value="HR"> Hotel Restaurant </option>
                  </select>
                </div>
              </div>
            </div>
              ...
              <div class="col-md-5">
                <div class="form-group">
                  <select class="form-control selectTo" name="" id="Restaurant">
                    ...
                    @foreach($RestaurantArray as $RestaurantData)
                      <option value="{{$RestaurantData->RestaurantId}}"> {{$RestaurantData->Restaurant}} ({{$RestaurantData->City}}) </option>
                    @endforeach
                  </select>
                </div>
              </div>
              ...
              <div class="col-md-3">
                <div class="form-group">
                  <select class="form-control selectTo" name="" id="Company">
                    ...
                    <option value="{{$CompanyArrayData->ContactsId}}"> {{$CompanyArrayData->CompanyDesc}} </option>
                    @endforeach
                  </select>
                </div>
              </div>
              ...
              <div class="col-md-3">
                <div class="form-group">
                  <select class="form-control selectTo" name="" id="Inbound">
                    <option value=""></option>
                    @foreach($InboundArray as $InboundArrayData)
                    <option value="{{$InboundArrayData->UsersId}}"> {{$InboundArrayData->uname}} ({{$InboundArrayData->UserShortcut}}) </option>
                    @endforeach
                  </select>
                </div>
              </div>
